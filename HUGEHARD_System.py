...
#terminal
def ter():
    terinfo = gui.buttonbox(msg = "Application: Terminal", title = "HUGEHARD System", choices = ("Open", "Info", "Cancel"), image = "/Users/jacobduan/Desktop/WORK/MY_NAME_IS_HACK-BETA/Images/Terminal.gif")
    if terinfo == "Open":
...
def bs():
    while True:
        ...
        if web == "tools.me":
            gui.textbox(msg = "tools.me\nCOPYRIGHT TOOLS.ME, TEMPLE MONKEY COMPANY", text = "Welcome to tools.me, there are a lot of free tools and fee-paying tools here", title = "Waterf0X")
